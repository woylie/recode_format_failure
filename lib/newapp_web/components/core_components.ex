defmodule NewappWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: NewappWeb.Gettext
  ...
  attr :class, :string,
    default: nil,
    doc: "the input class to use over defaults"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NewappWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NewappWeb.Gettext, "errors", msg, opts)
    end
  end
